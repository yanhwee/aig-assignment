...
from Knight_Spartan import *
from Archer_Spartan import *
from Wizard_Spartan import *
...
def run():
    ...
    blue_knight = Knight_Spartan(world, blue_knight_image, blue_base, Vector2(blue_base.spawn_position))
    ...
    blue_archer = Archer_Spartan(world, blue_archer_image, blue_arrow_image, blue_base, Vector2(blue_base.spawn_position))
    ...
    blue_wizard = Wizard_Spartan(world, blue_wizard_image, blue_rock_image, blue_base, Vector2(blue_base.spawn_position), blue_explosion_image)
